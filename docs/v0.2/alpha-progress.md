...
host share or network. Parser and packer tests pass; the request is not yet
read by the booting guest or generated by the host control plane.
...
1. Wire the request into a production inspector boot using admitted
   helper/kernel/initramfs artifacts. Connect the journaled
